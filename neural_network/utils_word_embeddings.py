...
#model = api.load("word2vec-google-news-300")   ### as seen at https://github.com/piskvorky/gensim-data on 21st Feb 2024
...
def get_mean_embedding(review_tokens):
    ...
    if embeddings:
        ...
        return np.zeros(model.vector_size)  # return a zero vector for out-of-vocabulary words of the size of the model